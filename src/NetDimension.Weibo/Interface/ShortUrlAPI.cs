...
namespace NetDimension.Weibo.Interface {
	internal class ShortUrlAPI : WeiboAPI {
		...
		public string Clicks(string url_short) {
			return (this.Client.GetCommand("short_url/clicks", new WeiboParameter("url_short", url_short)));
		}
		...
		public string Referers(string url_short) {
			return (this.Client.GetCommand("short_url/referers", new WeiboParameter("url_short", url_short)));
		}
		...
		public string Locations(string url_short) {
			return (this.Client.GetCommand("short_url/locations", new WeiboParameter("url_short", url_short)));
		}
		...
		public string Info(params string[] url_short) {
			var parameters = new List<WeiboParameter>();

			foreach (string u in url_short) {
				parameters.Add(new WeiboParameter("url_short", u));
			}

			return (this.Client.GetCommand("short_url/info", parameters.ToArray()));
		}
		...
		public string Shorten(params string[] url_long) {
			...
			return (this.Client.GetCommand("short_url/shorten", parameters.ToArray()));
		}
		...
		public string Expand(params string[] url_short) {
			...
			return (this.Client.GetCommand("short_url/expand", parameters.ToArray()));
		}
		...
		public string ShareCounts(string[] url_short) {
			...
			return (this.Client.GetCommand("short_url/share/counts", parameters.ToArray()));
		}
		...
		public string ShareStatuses(string urlShort, string sinceID = "", string maxID = "", int count = 20, int page = 1) {
			...
			return (this.Client.GetCommand("short_url/share/statuses", parameters.ToArray()));
		}
		...
		public string CommentCounts(string[] url_short) {
			...
			return (this.Client.GetCommand("short_url/comment/counts", parameters.ToArray()));
		}
		...
		public string CommentComments(string urlShort, string sinceID = "", string maxID = "", int count = 20, int page = 1) {
			...
			return (this.Client.GetCommand("short_url/comment/comments", parameters.ToArray()));
		}
	}
}
