...
namespace NetDimension.Weibo.Interface {
	internal class AccountAPI : WeiboAPI {
		...
		public string GetPrivacy() {
			return (this.Client.GetCommand("account/get_privacy"));
		}
		...
		public string SchoolList(string province = "", string city = "", string area = "", string type = "1", string capital = "", string keyword = "", int count = 10) {
			...
			return (this.Client.GetCommand("account/profile/school_list",
			                               p.ToArray()));
		}
		...
		public string RateLimitStatus() {
			return (this.Client.GetCommand("account/rate_limit_status"));
		}
		...
		public string GetUID() {
			return (this.Client.GetCommand("account/get_uid"));
		}
		...
		public string EndSession() {
			return (this.Client.GetCommand("account/end_session"));
		}
		...
		public string VerifyNickname(string nickname) {
			return (this.Client.GetCommand("register/verify_nickname", new WeiboParameter("nickname", nickname)));
		}
		...
		public string UnreadCount(string uid, string callback = "") {
			return (this.Client.GetCommand("https://rm.api.weibo.com/2/remind/unread_count.json",
		...
		public string SetCount(ResetCountType type) {
			return (this.Client.PostCommand("https://rm.api.weibo.com/2/remind/set_count.json", new WeiboParameter("type", type)));
		}
	}
}
