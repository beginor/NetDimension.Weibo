...
namespace NetDimension.Weibo.Interface.Entity {
	...
	public class UserInterface : WeiboInterface {
		...
		public Entities.user.Entity Show(string uid = "", string screenName = "") {
			return JsonConvert.DeserializeObject<Entities.user.Entity>(this.api.Show(uid, screenName));
		}
		...
		public Entities.user.Entity ShowByDomain(string domain) {
			return JsonConvert.DeserializeObject<Entities.user.Entity>(this.api.ShowByDomain(domain));
		}
		...
		public IEnumerable<Count> Counts(params string[] uids) {
			return JsonConvert.DeserializeObject<IEnumerable<Count>>(this.api.Counts(uids));
		}
	}
}
