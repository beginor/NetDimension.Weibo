...
namespace NetDimension.Weibo.Interface {
	internal class CommonAPI : WeiboAPI {
		...
		public string CodeToLocation(params string[] codes) {
			return (this.Client.GetCommand("common/code_to_location", new WeiboParameter("codes", string.Join(",", codes))));
		}
		...
		public string GetCity(string province, string capital = "") {
			return (this.Client.GetCommand("common/get_city",
		...
		public string GetProvince(string country, string capital = "") {
			return (this.Client.GetCommand("common/get_province",
		...
		public string GetCountry(string capital = "") {
			return (this.Client.GetCommand("common/get_country",
			                               new WeiboParameter("capital", capital)));
		}
		...
		public string GetTimezone() {
			return (this.Client.GetCommand("common/get_timezone"));
		}
	}
}
