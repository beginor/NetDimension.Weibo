...
namespace NetDimension.Weibo.Interface.Entity {
	...
	public class SearchInterface : WeiboInterface {
		private readonly SearchAPI api;
		...
		public IEnumerable<User> Users(string q, int count = 10) {
			return JsonConvert.DeserializeObject<IEnumerable<User>>(this.api.Users(q, count));
		}
		...
		public IEnumerable<Status> Statuses(string q, int count = 10) {
			return JsonConvert.DeserializeObject<IEnumerable<Status>>(this.api.Statuses(q, count));
		}
		...
		public IEnumerable<School> Schools(string q, int count = 10, int type = 0) {
			return JsonConvert.DeserializeObject<IEnumerable<School>>(this.api.Schools(q, count, type));
		}
		...
		public IEnumerable<string> Companies(string q, int count = 10) {
			return Utility.GetStringListFromJSON(this.api.Companies(q, count));
		}
		...
		public IEnumerable<App> Apps(string q, int count = 10) {
			return JsonConvert.DeserializeObject<IEnumerable<App>>(this.api.Apps(q, count));
		}
		...
		public IEnumerable<AtUser> AtUsers(string q, int count = 10, int type = 0, int range = 2) {
			return JsonConvert.DeserializeObject<IEnumerable<AtUser>>(this.api.AtUsers(q, count, type, range));
		}
		...
		public Collection Topics(string q, int count = 10, int page = 1) {
			return JsonConvert.DeserializeObject<Collection>(this.api.Topics(q, count, page));
		}
	}
}
