...
namespace NetDimension.Weibo.Interface {
	internal class TagAPI : WeiboAPI {
		...
		public string Tags(string uid, int count = 20, int page = 1) {
			return (this.Client.GetCommand("tags",
		...
		public string TagsBatch(params string[] uids) {
			return (this.Client.GetCommand("tags/tags_batch",
		...
		public string Suggestions(int count = 10) {
			return (this.Client.GetCommand("tags/suggestions", new WeiboParameter("count", count)));
		}
		...
		public string Create(params string[] tags) {
			return (this.Client.PostCommand("tags/create",
		...
		public string Destroy(string id) {
			return (this.Client.PostCommand("tags/destroy",
		...
		public string DestroyBatch(params string[] ids) {
			return (this.Client.PostCommand("tags/destroy_batch",
