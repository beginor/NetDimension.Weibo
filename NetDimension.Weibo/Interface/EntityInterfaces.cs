...
namespace NetDimension.Weibo.Interface {
	...
	public class EntityInterfaces {
		...
		public EntityInterfaces(Client client) {
			this.Account = new AccountInterface(client);
			this.Comments = new CommentInterface(client);
			this.Common = new CommonInterface(client);
			this.Favorites = new FavoriteInterface(client);
			this.Friendships = new FriendshipInterface(client);
			this.Search = new SearchInterface(client);
			this.ShortUrl = new ShortUrlInterface(client);
			this.Statuses = new StatusInterface(client);
			this.Suggestions = new SuggestionInterface(client);
			this.Tags = new TagInterface(client);
			this.Trends = new TrendInterface(client);
			this.Users = new UserInterface(client);
		}
